...
return [
     ...
     */
    // None. This app queues nothing — every click is one call to the daemon
    // at human speed — and the one long-lived job it has (rheo:watch) is a
    // ChildProcess, not a queue. The default worker would poll a jobs table
    // that does not exist and log an error every three seconds.
    'queue_workers' => [],
