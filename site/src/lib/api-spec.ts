...
export const specTable: ApiSpec = {
  ...
  "files": { "camera:0x2300000fd9009c": "ep12/cam-facetime.mov", "microphone:Scarlett_2i2": "ep12/mic-mv7.wav" } }`,
				...
				},
				{
					...
					response: `{ "id": "tk_7f3a", "stream": "window:11597", "path": "ep12/window-keynote.mov",
  "started": "2026-09-11T14:06:17.021Z", "timecode": "14:06:17:00" }`,
					...
					ws: ws('POST', '/takes/tk_7f3a/join', '{ "stream": "window:11597" }'),
				},
				{
					method: 'POST',
					path: '/takes/{id}/leave',
					...
					request: [{ name: 'stream', type: 'string', required: true, note: 'The stream id.' }],
					response: `{ "id": "tk_7f3a", "stream": "window:11597", "stopped": "2026-09-11T14:08:31.115Z", "frames": 8045 }`,
					ws: ws('POST', '/takes/tk_7f3a/leave', '{ "stream": "window:11597" }'),
				},
				{
					method: 'POST',
